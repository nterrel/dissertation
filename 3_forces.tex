...
\authorRemark{Without any additional logic to decide valences, RDKit tries to retain the same as before---even when the} \verb|AddHs| \authorRemark{function is used.}
