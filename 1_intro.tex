...
Supervised training of ML models involves iteratively passing data through the networks, \authorRemark{forcing} the model to predict a desired property of the data.
...
\begin{figure}[hb]
    ...
    \caption[Example of atomic environment vector construction]{Example of the terms in an AEV for the lone oxygen in the C$_6$H$_{10}$O molecule used in Fig. \ref{fig:aev_radius}. \authorRemark{Say a bit more about this process.}}
