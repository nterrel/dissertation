...
\title{Use the Forces: Advancing ANI Neural Network Potentials for Large-Scale Molecular Simulations}%  Put your title here.
...
\setReferenceFile{9_references}{achemso}%         References. First argument is your bibtex source file
%                                                       the second argument is your bibtex style file.

\setBiographicalFile{10_biography}%                Biography file of the Author (you).
...
\setAppendixFile{8_appendix}%                     Appendix Content; hyperlinking might be weird.
